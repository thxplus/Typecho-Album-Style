(function ($) {
    $.fn.barousel = function (callerSettings) {
        var settings = $.extend({
            imageWrapper: '.ad_image',
            contentWrapper: '.ad_content',
            ...
            fadeInSpeed: 100, //fade duration in milliseconds 
            manualCarousel: 0, //manual carousel if set to 1
            contentResize: 0, //resize content container
            contentResizeSpeed: 600, //content resize speed in milliseconds
            debug: 0
        }, callerSettings || {});
        ...
        if (settings.totalItem == 1) {
            ...
            if (settings.navType == 1) {
                ...
                var strNavList = "<ul>";
                strNavList += "<li class='prev'><a href='#' title=''>&nbsp;</a></li>";
                strNavList += "<li class='next'><a href='#' title=''>&nbsp;</a></li>";
...
$(document).ready(function(){
	$('#ad_banner').barousel({ navType: 2 });
	$('.ad_nav li.next, .ad_nav li.prev').css({opacity:.2});
	$('.ad_nav li.next, .ad_nav li.prev').hover(function(){$(this).animate({opacity:1},{duration:200,queue:false},"easeOutSine")},function(){$(this).animate({opacity:.2},{duration:300,queue:false},"easeOutSine")});
	$('.ad_nav').css("opacity","0");
	$('.ad_nav').css("display","block");
	$('#ad_banner').hover(function(){$('.ad_nav').animate({opacity:1},{duration:200,queue:false})},function(){$('.ad_nav').animate({opacity:0},{duration:200,queue:false})});
}) ;